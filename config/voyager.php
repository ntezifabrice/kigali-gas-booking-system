...
return [
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['migrations', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'settings', 'categories', 'permissions', 'posts', 'roles', 'user_roles', 'translations', 'permissions', 'pages', 'currencies'],
        ],
    ...
    */
    ...
    'dashboard' => [
        ...
        'widgets' => [
            'App\\Widgets\\Agents',
            'App\\Widgets\\FinishedBooking',
            'App\\Widgets\\Consumers',
            'App\\Widgets\\PendingBooking',
            'App\\Widgets\\ActiveBooking',
            'App\\Widgets\\CancelledBooking'
        ],
