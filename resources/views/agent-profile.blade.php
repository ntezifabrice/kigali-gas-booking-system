...
@section('breadcrumb')<li class="active">Agent Profile</li>@endsection
@section('menu')
...
@section('main')
    ...
    <div class="dashboard-content">
        ...
        <div class="row">
            <form method="POST" action="{{url('/dashboard/agent/profile')}}" enctype="multipart/form-data">
            {{csrf_field()}}
            <!-- Profile -->
                    ...
                    <div class="dashboard-list-box margin-top-0">
                        ...
                        <div class="dashboard-list-box-static">
                            ...
                            <div class="my-profile">
                                ...
                                <a href="{{url('dashboard/agent/password')}}" style="background: green" class="button pull-right"><i class="sl sl-icon-lock"></i> Edit password</a>
                            </div>
